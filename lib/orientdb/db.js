...
Db.prototype.command = function(command, options, callback) {
    ...
    data.mode = parser.isString(options.mode) ? options.mode : "";
    data.fetchPlan = parser.isString(options.fetchPlan) ? options.fetchPlan : "";
    data.non_text_limit = parser.isNumber(options.non_text_limit) ? options.non_text_limit : -1;
    var fetchORIDs = parser.isBoolean(options.fetchORIDs) ? options.fetchORIDs : true;
