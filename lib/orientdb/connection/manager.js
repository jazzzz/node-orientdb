...
Manager.prototype.readResponse = function(data) {
    ...
    do {
        ...
        // on this loop iteration, fire the callback.
        if (command.instance.done()) {
            command.callback(command.instance.error, command.instance.result);
        }
...
Manager.prototype.writeRequest = function(sessionId, operationType, data, callback) {
    ...
    var instance = new self.operations[operationType];
    var command = {
