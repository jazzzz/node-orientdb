...
var Server = exports.Server = function(options) {
    ...
    if (this.options.logger != null && _.isFunction(this.options.logger.debug) && _.isFunction(this.options.logger.error)) {
...
Server.prototype.send = function(operation, options, callback) {
    ...
    return self.manager.writeRequest(self.sessionId, operation, options, callbackToCall);
};
...
Server.prototype.disconnect = function(callback) {
    ...
    return self.send(OperationTypes.DB_CLOSE, callback);
};
...
Server.prototype.shutdown = function(callback) {
    ...
    return self.send(OperationTypes.SHUTDOWN, data, callback);
};
