...
var serializeFieldValue = function(value) {
    ...
    if (_.isString(value)) {
        if (REGEXP_RID.test(value)) {
            ...
            result = result.concat("\"", escapeString(value), "\"");
        }
...
var parseRid = function(rid) {
    // TODO allow also rid as object literal
    if (_.isString(rid) && REGEXP_RID.test(rid)) {
...
var hashToSQLSets = function(hash) {
    ...
    for (var field in hash) {
        ...
        if (_.isBoolean(value) || _.isNumber(value) || _.isString(value) || _.isDate(value)) {
            if (_.isString(value) && !isRid(value)) {
                value = "\"".concat(escapeString(value), "\"");
            } else if (_.isDate(value)) {
                value = value.getTime();
            }
